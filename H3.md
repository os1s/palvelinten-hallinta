...
Kokeilin vielä huvikseni kloonata repon windowskoneelleni, sekin onnistui 
helposti:
...
```
$ git blame README.md
fd78d666 (Oscar Isomäki 2018-11-12 00:03:22 +0200 1) # salt schoolwork
```
...
Päätin tehdä loppuun moduulin, jonka tekemisen aloitin jo viime tunnilla. Moduuli
asentaa screenin ja irssin, vaihtaa uuden käyttäjän teeman ja vaihtaa joitain asetuksia.
Moduulin tiedostot:
```
